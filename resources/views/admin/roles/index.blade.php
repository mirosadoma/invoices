                        ...
                        <form class="dt_adv_search" method="GET">
                            <div class="row g-1 mb-md-1">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="created_at" class="form-control dt-input" data-column="6" min="2023-01-01" max="{{\Carbon\Carbon::now()->addYear()->format('Y')}}-01-01" value="{{old('created_at', request('created_at'))}}" data-column-index="5" />
                                </div>
                            </div>
