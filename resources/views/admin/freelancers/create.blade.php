...
@section('head_title'){{__('Add Freelancer')}}@endsection
@section('content')
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title"> @lang("Add Freelancer") </h5>
    </div>
    <div class="card-body table-responsive">
        <form class="form-horizontal" action="{{route('app.freelancers.store')}}" method="post" enctype="multipart/form-data">
            <fieldset>
                @csrf
                <div class="form-body">
...
@push('scripts')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Dashboard\Freelancers\StoreRequest') !!}
    {{-- <script>
