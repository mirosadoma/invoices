                                                    ...
                                                    <tr>
                                                        <td width="470" align="center" valign="top">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                <tr>
                                                                    <td align="center">
                                                                        <h1 style="color: #5d541d;direction: rtl;"> {{ $data['welcome_msg'] }}&nbsp;{{$data['user_name']}} </h1>
                                                                        <p>في المتجر الإلكترنى الخاص بشركة AICTEC</p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center" class="es-p40t es-p40b">
                                                                        <h3 style="direction: rtl;">نشكرك على اشتراكك معنا</h3>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                                                    ...
                                                    <tr>
                                                        <td width="470" align="left">
                                                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                <tr>
                                                                    <td align="center">
                                                                        <p style="font-size: 14px;direction: rtl;">@lang("Thanks")<br />@lang("Team")&nbsp;{{$data['project_name']}} !</p>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
